...
namespace SKIT.Utility.UnitTests
{
    public class ShaUtilUnitTests
    {
        ...
        public void Sha384Test()
        {
            /**
             * ע�⣺
             * �ܶ����߹����ϵ� HMAC-SHA384 ����Ǵ���ģ���Ϊ��ʹ�õ��Ǿɰ汾 crypto.js��REF: https://code.google.com/archive/p/crypto-js/issues/84����
             * ����ʹ�� https://www.freeformatter.com/hmac-generator.html#ad-output ����֤��
             */
